...
public class LoadingFeedItemView extends FrameLayout {
    ...
    private void init() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.item_feed_loader, this, true);
        vSendingProgress = (SendingProgressView) view.findViewById(R.id.vSendingProgress);
        vProgressBg = view.findViewById(R.id.vProgressBg);
    }
