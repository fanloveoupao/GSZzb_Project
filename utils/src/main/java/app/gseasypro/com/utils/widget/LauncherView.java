...
public class LauncherView extends RelativeLayout {
    private int mHeight;
    private int mWidth;
    private int dp80 = TypedValueUtil.fromDip(80);
    private boolean mHasStart;


    private launcherDone listener;

    public interface launcherDone {
        void animEnd();
    }

    public void setListener(launcherDone listener) {
    ...
    private void addAnimation(ObjectAnimator animator1, ObjectAnimator animator2, ImageView target) {
        ...
        all2.addListener((Animator.AnimatorListener) new AnimEndListener(target));
