...
public class FeedItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getItemViewType() == BeautifulGsAdapter.VIEW_TYPE_DEFAULT) {
            if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
                lastAddAnimatedItem++;
                runEnterAnimation((BeautifulGsAdapter.CellFeedViewHolder) viewHolder);
                return false;
            }
        }
    ...
    private void runEnterAnimation(final BeautifulGsAdapter.CellFeedViewHolder holder) {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
            ...
            BeautifulGsAdapter.CellFeedViewHolder holder = (BeautifulGsAdapter.CellFeedViewHolder) newHolder;

            animateHeartButton(holder);
            updateLikesCounter(holder, holder.getFeedItem().likesCount);
            if (BeautifulGsAdapter.ACTION_LIKE_IMAGE_CLICKED.equals(feedItemHolderInfo.updateAction)) {
    ...
    private void animateHeartButton(final BeautifulGsAdapter.CellFeedViewHolder holder) {
    ...
    private void updateLikesCounter(BeautifulGsAdapter.CellFeedViewHolder holder, int toValue) {
    ...
    private void animatePhotoLike(final BeautifulGsAdapter.CellFeedViewHolder holder) {
    ...
    private void dispatchChangeFinishedIfAllAnimationsEnded(BeautifulGsAdapter.CellFeedViewHolder holder) {
    ...
    private void resetLikeAnimationState(BeautifulGsAdapter.CellFeedViewHolder holder) {
