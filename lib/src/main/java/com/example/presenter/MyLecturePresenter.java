...
public class MyLecturePresenter extends BasePresenter<MyLecturePresenter.MyLectureIView> {


    public interface MyLectureIView extends IView {
    ...
    public MyLecturePresenter(MyLectureIView viewer) {
        super(viewer);
    }

    public void initMyLectureData() {
